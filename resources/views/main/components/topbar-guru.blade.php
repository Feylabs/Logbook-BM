        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img height="50px" src="{{ URL::to('bootstrap_ui') }}/assets/images/logo_main.png" alt="homepage"
                            class="dark-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img  height="35px" src="{{ URL::to('bootstrap_ui') }}/assets/images/long_logo.png" alt="homepage"
                            class="dark-logo" />
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <span class="ml-2 d-none d-lg-inline-block"><span>Assalamualaikum,</span> <span
                                class="text-dark">{{ Auth::guard('guru')->user()->name }}</span> <i
